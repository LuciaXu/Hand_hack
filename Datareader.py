...
def Datareader(config):
    ...
    Seq1 = ds.loadSequence('train', shuffle=True, rng=rng, docom=True, allJoints=True,Nmax=50)
    trainSeqs = [Seq1]
    ...
    Seq2 = ds.loadSequence('test', shuffle=True, rng=rng,docom=True,allJoints=True,Nmax=50)
    testSeqs = [Seq2]
