...
def Datareader(config):
    ...
    Seq1= ds.loadAugSequence('train', shuffle=True, rng=rng, docom=True,allJoints=True,Nmax=1,num_aug=1)
    ...
    Seq2 = ds.loadSequence('test', shuffle=True, rng=rng,docom=True,allJoints=True,Nmax=1)
    testSeqs = [Seq2]
